...
import shakiba.enur.skatexmath.awt.GraphicsEnvironment;
import shakiba.enur.skatexmath.awt.Toolkit;
...
public class TeXFormula {
    ...
    public TeXFormula(String s, Map<String, String> map) throws ParseException {
        ...
        Log.d("character", " Textformula before parse drawChars: 233" + s);
        parser.parse();
    }
    ...
    public TeXFormula(String s) throws ParseException {
        ...
        Log.d("character", " Textformula drawChars: " + s);
    }

    public TeXFormula(String s, boolean firstpass) throws ParseException {
        this.textStyle = null;
        Log.d("character", " Textformula before parse drawChars: 251" + s);
    ...
    public TeXFormula(String s, String textStyle) throws ParseException {
        ...
        Log.d("character", " Textformula before parse drawChars: 264" + s);
        parser.parse();
    }
    ...
    public TeXFormula(String s, String textStyle, boolean firstpass, boolean space) throws ParseException {
        ...
        Log.d("character", " Textformula before parse drawChars: 272" + s);
        parser.parse();
    }
    ...
    protected TeXFormula(TeXParser tp, String s, boolean firstpass) throws ParseException {
        ...
        if (isPartial) {
            try {
                Log.d("character", " Textformula before parse drawChars: 316" + s);
                parser.parse();
            } catch (Exception e) { }
        } else {
            parser.parse();
    ...
    protected TeXFormula(TeXParser tp, String s, String textStyle) throws ParseException {
        ...
        if (isPartial) {
            try {
                ...
                Log.d("character", " Textformula before parse drawChars: 337" + s);
            } catch (Exception e) {
                if (root == null) {
                    root = new EmptyAtom();
                }
    ...
    public class TeXIconBuilder {
        ...
        public TeXIconBuilder setFontName(final String fontName) {
