...
public class DefaultTeXFont implements TeXFont {
    ...
    public static void addAlphabet(Object base, Character.UnicodeBlock[] alphabet, String language) throws ResourceParseException {
        ...
        if (!b) {
            ...
            addTeXFontDescription(base, SKatexMathAndroid.getResourceAsStream(language), language);
    ...
    public static void addAlphabet(Character.UnicodeBlock alphabet, String name) {
        ...
        try {
            DefaultTeXFont.addAlphabet(alphabet, SKatexMathAndroid.getResourceAsStream(lg), lg, SKatexMathAndroid.getResourceAsStream(sym), sym, SKatexMathAndroid.getResourceAsStream(map), map);
