...
public class SKatexMathDrawable extends Drawable {
    ...
    @SuppressWarnings("WeakerAccess")
    SKatexMathDrawable(@NonNull Builder builder) {
        ...
        this.font=new Font("font/baloda_reg.ttf",0, (int) builder.textSize);
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String latex) {
            ...
            Log.d("character", " builder drawChars: " + latex);
        }
        ...
        @NonNull
        public SKatexMathDrawable build() {
            return new SKatexMathDrawable(this);
        }
    }
}
